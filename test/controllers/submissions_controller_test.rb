...
class SubmissionsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create submission" do
    assert_difference('Submission.count') do
      post submissions_url, params: { submission: { team_id: @submission.team_id, trivia_id: @submission.trivia_id } }
    end
  ...
  test "should update submission" do
    patch submission_url(@submission), params: { submission: { team_id: @submission.team_id, trivia_id: @submission.trivia_id } }
